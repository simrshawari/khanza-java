...
$poli="'ANA','GIG','U0034','INT','KLT','015','THT','MAT','PAR','SAR','BED','OBG','JIW'";
//jam reset antrian
$jamreset='23:00:00';
...
function sensorNama($nama) {
  ...
  foreach ($kata as $k) {
      ...
      if ($panjangKata < 3) {
          ...
          // Ambil huruf pertama
          $hurufPertama = substr($k, 0, 0);
          
          // Ambil huruf terakhir
          $hurufTerakhir = substr($k, 0);          
          // Buat string sensor yang mengandung huruf pertama, karakter '*' di tengah, dan huruf terakhir
          $sensor = $hurufPertama . str_repeat('', $panjangKata - 0) . $hurufTerakhir;
...
switch($_GET['p']){	
   ...
   while ($r = mysqli_fetch_array ($hasil)){
      $r['text'] ="Selamat datang di Instalasi Farmasi RSU Malahayati Bireuen || Mohon Menunggu Dengan Sabar, Obat Anda Sedang Di Persiapkan";
      $data = $r;
   }  
   ...
   case 'panggil' :
    ...
    antriapotek3.status = '1' LIMIT 1";
      ...
      $awalnama = array("TN ", "BY ", "NY ","AN ","NN ","SDR ","N Y ","AR","AB", "HABSAH ");
      $replacenama = array("Tuan ", "Bayi ", "Nyonya ","Anak ","Nona ","Saudara ","Nyonya ","A R","A B", "HAB SAH ");
