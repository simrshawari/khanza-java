...
public class frmUtama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        internalFrame1.setWarnaAtas(new java.awt.Color(0, 102, 102));
        internalFrame1.setWarnaBawah(new java.awt.Color(0, 153, 153));
        internalFrame1.setLayout(new java.awt.BorderLayout());

        BtnCetak.setBackground(new java.awt.Color(153, 153, 255));
        BtnCetak.setForeground(new java.awt.Color(204, 255, 102));
        BtnCetak.setText("Cetak Antrian");
        BtnCetak.setFont(new java.awt.Font("Tahoma", 1, 80)); // NOI18N
        BtnCetak.setGlassColor(new java.awt.Color(0, 51, 102));
        ...
        LabelNomor.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                LabelNomorAncestorAdded(evt);
            }
        ...
        LabelTanggal.setForeground(new java.awt.Color(153, 255, 255));
        LabelTanggal.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        LabelTanggal.setText("ANTRIAN PENDAFTARAN   :");
    ...
    private void BtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCetakActionPerformed
        if(Sequel.menyimpantf("antripendaftaran_nomor","'"+LabelNomor.getText()+"','0',concat(current_date(),' ',current_time()),''","Nomor Antrian")==true){
            ...
            Valid.MyReportqry("rptAntriLoket.jasper","report","::[ Antrian Loket ]::",
                   "select antripendaftaran_nomor.jam AS tanggal,antripendaftaran_nomor.nomor from antripendaftaran_nomor where LEFT(antripendaftaran_nomor.jam,10)=current_date and antripendaftaran_nomor.nomor='"+LabelNomor.getText()+"' ",param);
    ...
    private void LabelNomorAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_LabelNomorAncestorAdded
        // TODO add your handling code here:
    }//GEN-LAST:event_LabelNomorAncestorAdded
