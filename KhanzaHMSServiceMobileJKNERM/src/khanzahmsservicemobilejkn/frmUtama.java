                                    ...
                                    if (rs2.next()) {
                                        ...
                                        if ((!kodedokter.equals("")) && (!kodepoli.equals(""))) {
                                            ...
                                            if (task3.equals("")) {
                                                ...
                                                datajam = Sequel.cariIsi("SELECT taskid_1 FROM antripendaftaran WHERE antripendaftaran.no_rawat =?", rs.getString("no_rawat"));
                                                if (!datajam.equals("")) {
                                                    if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "1", datajam}) == true) {
                                                        ...
                                                        try {
                                                            ...
                                                            //      "insert into log_add_antrian values('0','"+rs.getString("tgl_registrasi")+"','"+rs.getString("no_rawat")+"','1','admin','"+utc+"','"+rs.getString("nm_pasien")+"','"+rs.getString("no_rawat")+"',"+
                                                            //     "'"+rs.getString("nm_poli")+"','"+root+"','"+nameNode.path("code").asText()+"','"+requestJson+"','"+headers+"','"+URL+"')").executeUpdate();
                                                            //    Sequel.menyimpanbpjs("log_taskid", "?,?,?",3, new String[]{rs.getString("no_rawat"),nameNode.path("code").asText(),nameNode.path("message").asText()});
                                                        } catch (Exception ex) {
                                                            System.out.println("Notifikasi Bridging : " + ex);
                                                        }
                                                    }
                                                ...
                                                datajam = Sequel.cariIsi("SELECT taskid_2 FROM antripendaftaran WHERE antripendaftaran.no_rawat =?", rs.getString("no_rawat"));
                                                if (!datajam.equals("")) {
                                                    if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "2", datajam}) == true) {
                                                        ...
                                                        try {
                                                            ...
                                                            //     koneksibpjs.prepareStatement(
                                                            //        "insert into log_add_antrian values('0','"+rs.getString("tgl_registrasi")+"','"+rs.getString("no_rawat")+"','2','admin','"+utc+"','"+rs.getString("nm_pasien")+"','"+rs.getString("no_rawat")+"',"+
                                                            //         "'"+rs.getString("nm_poli")+"','"+root+"','"+nameNode.path("code").asText()+"','"+requestJson+"','"+headers+"','"+URL+"')").executeUpdate();
                                                            //    Sequel.menyimpanbpjs("log_taskid", "?,?,?",3, new String[]{rs.getString("no_rawat"),nameNode.path("code").asText(),nameNode.path("message").asText()});
                                                        } catch (Exception ex) {
                                                            System.out.println("Notifikasi Bridging : " + ex);
