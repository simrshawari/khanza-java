...
public final class DlgRawatInap extends javax.swing.JDialog {
    private final DefaultTableModel tabModeDr,tabModePr,tabModeDrPr,
            tabModePemeriksaan,tabModeObstetri,tabModeGinekologi,tabModePemeriksaanSbar,tabModePemeriksaanTbak,tabModePemeriksaanAdime;
    ...
    private void initComponents() {
        ...
        tbPemeriksaanSbar1 = new widget.Table();
        ...
        tbPemeriksaanSbar1.setAutoCreateRowSorter(true);
        tbPemeriksaanSbar1.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbPemeriksaanSbar1.setName("tbPemeriksaanSbar1"); // NOI18N
        tbPemeriksaanSbar1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbPemeriksaanSbar1MouseClicked(evt);
            }
        });
        tbPemeriksaanSbar1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbPemeriksaanSbar1KeyReleased(evt);
            }
        });
        Scroll9.setViewportView(tbPemeriksaanSbar1);
        ...
        scrollPane21.setBounds(70, 50, 360, 70);
        ...
        scrollPane22.setBounds(70, 130, 360, 70);

        jLabel106.setText("Situation :");
        jLabel106.setName("jLabel106"); // NOI18N
        panelGlass19.add(jLabel106);
        jLabel106.setBounds(0, 50, 70, 23);

        jLabel116.setText("Background :");
        jLabel116.setName("jLabel116"); // NOI18N
        panelGlass19.add(jLabel116);
        jLabel116.setBounds(0, 130, 70, 23);
        ...
        scrollPane23.setBounds(550, 50, 360, 70);

        jLabel119.setText("Asesmen :");
        jLabel119.setName("jLabel119"); // NOI18N
        panelGlass19.add(jLabel119);
        jLabel119.setBounds(450, 50, 90, 23);

        jLabel120.setText("Recommendation :");
        jLabel120.setName("jLabel120"); // NOI18N
        panelGlass19.add(jLabel120);
        jLabel120.setBounds(440, 130, 100, 23);
        ...
        scrollPane24.setBounds(550, 130, 360, 70);
        ...
        Jabatan4.setBounds(630, 10, 209, 23);
            ...
            switch (TabRawat.getSelectedIndex()) {
                ...
                if((!TSituation1.getText().trim().equals(""))||(!TBackground1.getText().trim().equals(""))||(!TAssesment1.getText().trim().equals(""))||
                    ...
                    if((!TKeluhan1.getText().trim().equals(""))||(!TPemeriksaan1.getText().trim().equals(""))||(!TSuhu1.getText().trim().equals(""))||
                        ...
                        if(KdPeg1.getText().trim().equals("")||TPegawai1.getText().trim().equals("")){
                            Valid.textKosong(KdPeg1,"Dokter/Paramedis masih kosong...!!");
                        }else{
                            if(akses.getkode().equals("Admin Utama")){
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void tbPemeriksaanSbar1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbPemeriksaanSbar1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tbPemeriksaanSbar1MouseClicked

    private void tbPemeriksaanSbar1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbPemeriksaanSbar1KeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_tbPemeriksaanSbar1KeyReleased
    ...
    */
    ...
    private widget.Table tbPemeriksaanSbar1;
