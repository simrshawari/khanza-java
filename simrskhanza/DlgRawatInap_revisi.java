 ...
 * @author perpustakaan
 */
public final class DlgRawatInap_revisi extends javax.swing.JDialog {
    ...
    /** Creates new form DlgRawatInap_revisi
     * @param parent
     * @param modal */
    public DlgRawatInap_revisi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        pasien.addWindowListener(new WindowListener() {
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgRawatInap_revisi")){
    ...
    private void initComponents() {
        ...
        BtnInputJadwalOP = new widget.Button();
        ...
        BtnInputJadwalOP.setForeground(new java.awt.Color(0, 0, 0));
        BtnInputJadwalOP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/History.png"))); // NOI18N
        BtnInputJadwalOP.setMnemonic('4');
        BtnInputJadwalOP.setText("Permintaan Operasi");
        BtnInputJadwalOP.setToolTipText("");
        BtnInputJadwalOP.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnInputJadwalOP.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnInputJadwalOP.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnInputJadwalOP.setName("BtnInputJadwalOP"); // NOI18N
        BtnInputJadwalOP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnInputJadwalOPActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnInputJadwalOP);
        BtnInputJadwalOP.setBounds(1090, 110, 160, 30);
        ...
        BtnInputJadwalOP1.setBounds(1090, 150, 160, 30);
    ...
    private void btnPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPasienActionPerformed
        akses.setform("DlgRawatInap_revisi");
        pasien.emptTeks();
        pasien.isCek();
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnInputJadwalOPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnInputJadwalOPActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        Valid.panggilUrl("jadwaloperasi.php");
        this.setCursor(Cursor.getDefaultCursor());
//        SwingHTMLBrowser browser = new SwingHTMLBrowser();
//        browser.setVisible(true);
//        browser.loadURL("http://lokal-rs.unhas.ac.id/dashboard");
//        //        try{
//            //            Desktop.getDesktop().browse(new URL("http://lokal-rs.unhas.ac.id/dashboard/").toURI());
//            //        }
//        //        catch (Exception e)
//        //        {}
//        //        // TODO add your handling code here:
    }//GEN-LAST:event_BtnInputJadwalOPActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRawatInap_revisi dialog = new DlgRawatInap_revisi(new javax.swing.JFrame(), true);
    ...
    private widget.Button BtnInputJadwalOP;
