            ...
            try {
                if(TCari.getText().trim().equals("")){
                    ps = koneksi.prepareStatement(
                            "select loinc.code,loinc.display,loinc.code_system from loinc where kategori='Radiologi' order by loinc.display asc limit " +cmbHlm.getSelectedItem().toString() + " ");

                }else{
                    ps = koneksi.prepareStatement(
                            "select loinc.code,loinc.display,loinc.code_system from loinc where kategori='Radiologi' and loinc.display like ? order by loinc.display asc limit " +cmbHlm.getSelectedItem().toString() + " ");
                }
