            ...
            try {
                if(TCari.getText().trim().equals("")){
                    ps = koneksi.prepareStatement(
                            "select * from snomed order by snomed.display asc limit " +cmbHlm.getSelectedItem().toString() + " ");

                }else{
                    ps = koneksi.prepareStatement(
                            "select * from snomed where snomed.display like ? order by snomed.display asc limit " +cmbHlm.getSelectedItem().toString() + " ");
                }
