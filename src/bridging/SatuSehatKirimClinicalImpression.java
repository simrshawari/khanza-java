...
public final class SatuSehatKirimClinicalImpression extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TabRawat.addTab("Clinical Impression", Scroll);
        ...
        TabRawat.addTab("Care Plan", Scroll1);
...
//            if(tbObat.getValueAt(i,0).toString().equals("true")&&(!tbObat.getValueAt(i,5).toString().equals(""))&&(!tbObat.getValueAt(i,11).toString().equals(""))&&(!tbObat.getValueAt(i,13).toString().equals(""))&&tbObat.getValueAt(i,16).toString().equals("")){
                if (tbObat2.getValueAt(i, 0).toString().equals("true")) {
                    try {
                        iddokter = cekViaSatuSehat.tampilIDParktisi(tbObat2.getValueAt(i, 12).toString());
                        ...
                        try {
                            ...
                            json = "{\n"
                                    ...
                                    + "    \"status\": \"active\",\n"
                                    + "    \"intent\": \"plan\",\n"
                                    + "    \"title\": \"" + tbObat2.getValueAt(i, 10).toString() + "\",\n"
                                    + "    \"description\": \"" + tbObat2.getValueAt(i, 10).toString() + "\",\n"
                                    + "    \"category\": [\n"
                                    + "        {\n"
                                    + "            \"coding\": [\n"
                                    + "                {\n"
                                    ...
                                    + "    },\n"
                                    + "    \"encounter\": {\n"
                                    + "        \"reference\": \"Encounter/" + tbObat2.getValueAt(i, 9).toString() + "\"\n"
                                    + "    },\n"
                                    + "    \"created\": \"" + tbObat2.getValueAt(i, 13).toString() + "T" + tbObat2.getValueAt(i, 14).toString() + "+07:00\","
                                    + "    \"author\": {\n"
                                    + "        \"reference\": \"Practitioner/" + iddokter + "\",\n"
                                    + "        \"display\": \"" + tbObat2.getValueAt(i, 11).toString() + "\"\n"
                                    + "    }\n"
                                    + "}";
                            ...
                            if (!response.asText().equals("")) {
                                Sequel.menyimpan("satu_sehat_careplan", "?,?,?,?,?", "no_rawat", 5, new String[]{
                                    tbObat2.getValueAt(i, 2).toString(), tbObat2.getValueAt(i, 13).toString(), tbObat2.getValueAt(i, 14).toString(), tbObat2.getValueAt(i, 7).toString(), response.asText()
                                });
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi Bridging : " + e);
