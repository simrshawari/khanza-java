            ...
            if(kenaikan>0){
                if(aktifkanbatch.equals("yes")){
                    ...
                    psobat=koneksi.prepareStatement(
                        ...
                        "databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,databarang.letak_barang,"+
                        "industrifarmasi.nama_industri,databarang.h_beli,databarang."+hppfarmasi+" as dasar, aturan_pakai.aturan,kategori_barang.nama as kategori,"+
                        "golongan_barang.nama as golongan,databarang.kode_sat,aturan_pakai.aturan from detail_pemberian_obat inner join databarang "+
                        "inner join aturan_pakai inner join resep_obat inner join jenis inner join golongan_barang inner join kategori_barang inner join "+
                        ...
                        "and detail_pemberian_obat.tgl_perawatan=aturan_pakai.tgl_perawatan and detail_pemberian_obat.jam=aturan_pakai.jam and "+
                        "detail_pemberian_obat.no_rawat=aturan_pakai.no_rawat and aturan_pakai.kode_brng= detail_pemberian_obat.kode_brng where "+
                        " resep_obat.no_resep=? and databarang.status='1' and databarang.kode_brng like ? or "+
                        " resep_obat.no_resep=? and databarang.status='1' and databarang.nama_brng like ? or "+
                        " resep_obat.no_resep=? and databarang.status='1' and kategori_barang.nama like ? or "+
                        " resep_obat.no_resep=? and databarang.status='1' and golongan_barang.nama like ? or "+
                        " resep_obat.no_resep=? and databarang.status='1' and jenis.nama like ? order by databarang.nama_brng");
                        ...
                        while(rsobat.next()){
                            ...
                            if(rsobat.getDouble("jml")>sisacari){
                                ...
                                tabMode.addRow(new Object[] {false,sisacari,rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                   rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("harga"),100),                                   
                                   rsobat.getString("nama"),0,0,sisacari,rsobat.getString("nama_industri"),
                                   rsobat.getDouble("dasar"),rsobat.getString("aturan"),rsobat.getString("kategori"),rsobat.getString("golongan"),"","",""
                                }); 
                            }else{
                                tabMode.addRow(new Object[] {false,rsobat.getString("jml"),rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                   rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("harga"),100),                                   
                ...
                if(aktifkanbatch.equals("yes")){
                    ...
                    psobat=koneksi.prepareStatement(
                        ...
                        "resep_obat.tgl_perawatan=detail_pemberian_obat.tgl_perawatan and databarang.kode_kategori=kategori_barang.kode "+
                        "and detail_pemberian_obat.tgl_perawatan=aturan_pakai.tgl_perawatan and detail_pemberian_obat.jam=aturan_pakai.jam and "+
                        "detail_pemberian_obat.no_rawat=aturan_pakai.no_rawat and aturan_pakai.kode_brng= detail_pemberian_obat.kode_brng "+
                        " where resep_obat.no_resep=? and databarang.status='1' and databarang.kode_brng like ? or "+
                        " resep_obat.no_resep=? and databarang.status='1' and databarang.nama_brng like ? or "+
                        " resep_obat.no_resep=? and databarang.status='1' and kategori_barang.nama like ? or "+
                        " resep_obat.no_resep=? and databarang.status='1' and golongan_barang.nama like ? or "+
                        " resep_obat.no_resep=? and databarang.status='1' and jenis.nama like ? order by databarang.nama_brng");
