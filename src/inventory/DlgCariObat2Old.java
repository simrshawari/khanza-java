 ...
 * @author dosen
 */
public final class DlgCariObat2Old extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariObat2Old(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariObat2Old dialog = new DlgCariObat2Old(new javax.swing.JFrame(), true);
