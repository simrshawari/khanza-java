 ...
 * @author dosen
 */
public final class DlgPeresepanDokter2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPeresepanDokter2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);
        tabModeResep=new DefaultTableModel(null,new Object[]{
                "K","Jumlah","Aturan Pakai","Stok","Kode Barang","Nama Barang","Satuan",
                "Komposisi","Harga(Rp)","Jenis Obat","I.F.","H.Beli"
            }){
    ...
    private void initComponents() {
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-07-2024" }));
        ...
        jLabel63.setBounds(690, 10, 70, 23);
        ...
        TglLahir.setBounds(760, 10, 100, 23);
        ...
        label21.setBounds(680, 70, 50, 23);
        ...
        kdgudang.setBounds(740, 70, 55, 23);

        nmgudang.setEditable(false);
        nmgudang.setName("nmgudang"); // NOI18N
        nmgudang.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(nmgudang);
        nmgudang.setBounds(800, 70, 150, 23);
        ...
        BtnGudang.setBounds(950, 70, 28, 23);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPeresepanDokter2 dialog = new DlgPeresepanDokter2(new javax.swing.JFrame(), true);
    ...
    public void tampilobat() {        
        ...
        for(i=0;i<tbResep.getRowCount();i++){
            if(!tbResep.getValueAt(i,1).toString().equals("")){
                ...
                kodebarang[z]=tbResep.getValueAt(i,4).toString();
                namabarang[z]=tbResep.getValueAt(i,5).toString();
                kodesatuan[z]=tbResep.getValueAt(i,6).toString();
                try {
                    letakbarang[z]=tbResep.getValueAt(i,7).toString();
                } catch (Exception e) {
                    letakbarang[z]="";
                }
                    
                try {
                    harga[z]=Double.parseDouble(tbResep.getValueAt(i,8).toString());
                } catch (Exception e) {
                    harga[z]=0;
                }                  
                namajenis[z]=tbResep.getValueAt(i,9).toString();
                industri[z]=tbResep.getValueAt(i,10).toString();
                try {
                    beli[z]=Double.parseDouble(tbResep.getValueAt(i,11).toString());
                } catch (Exception e) {
                    beli[z]=0;
                } 
                
                try {
                    stok[z]=Double.parseDouble(tbResep.getValueAt(i,3).toString());
                } catch (Exception e) {
                    stok[z]=0;
                } 
                z++;
        ...
        for(i=0;i<z;i++){
            tabModeResep.addRow(new Object[] {
                pilih[i],jumlah[i],aturan[i],stok[i],kodebarang[i],namabarang[i],kodesatuan[i],letakbarang[i],harga[i],namajenis[i],industri[i],beli[i]
            });
        }
        ...
        try {
            if(kenaikan>0){
                ...
                try{
                    ...
                    psresepasuransi.setString(2,kdgudang.getText());
                    ...
                    while(rsobat.next()){
                        tabModeResep.addRow(new Object[] {
                           false,"","",rsobat.getDouble("stok"),rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),rsobat.getString("kode_sat"),
                ...
                try{
                    psresep.setString(1,kdgudang.getText());
...
/*    public void emptTeksobat() {
    ...
    public void emptTeksobat() {
        if(ChkRM.isSelected()==true){
            Valid2.autoNomorSmc(NoResep, null, "resep_obat", "no_resep", 4, "0", DTPBeri.getSelectedItem());
        } 
    }
    ...
    public void setNoRm(String norwt,Date tanggal, String jam,String menit,String detik,String KodeDokter,String NamaDokter,String status) {        
        ...
        TNoRM.setText(Sequel.cariIsi("select reg_periksa.no_rkm_medis from reg_periksa where reg_periksa.no_rawat=?",norwt));
                        ...
                        try {
                            ...
                            if(carikapasitas.next()){ 
                                if(Sequel.menyimpantf2("resep_dokter","?,?,?,?","data",4,new String[]{
                                    NoResep.getText(),tbResep.getValueAt(i,4).toString(),
                ...
                if(Double.parseDouble(tabModeResep.getValueAt(r,1).toString())>0){
                    try {                
                        y=Math.round(Double.parseDouble(tabModeResep.getValueAt(r,1).toString())*
                          Double.parseDouble(tabModeResep.getValueAt(r,8).toString()));                                                
                    } catch (Exception e) {
                        y=0;
                    }
                    ttl=ttl+y;
