 ...
 * @author dosen
 */
public final class DlgPeresepanDokterRalankeRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPeresepanDokterRalankeRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPeresepanDokterRalankeRanap dialog = new DlgPeresepanDokterRalankeRanap(new javax.swing.JFrame(), true);
