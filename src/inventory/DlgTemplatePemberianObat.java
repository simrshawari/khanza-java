...
*/
    ...
    */
    ...
    public void tampil() {
        ...
        try{  
            if(NamaDokter.getText().equals("")&& TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_perawatan,resep_obat.jam_peresepan,"+
            ...
            try{
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        rs.getString("no_resep"),rs.getString("tgl_perawatan"),rs.getString("jam_peresepan"),rs.getString("no_rawat"),
                    ...
                    ps2=koneksi.prepareStatement("select databarang.kode_brng,databarang.nama_brng,detail_pemberian_obat.jml,"+
                        "databarang.kode_sat,aturan_pakai.aturan from detail_pemberian_obat inner join databarang inner join aturan_pakai inner join resep_obat on "+
                        ...
                        "detail_pemberian_obat.tgl_perawatan=resep_obat.tgl_perawatan and detail_pemberian_obat.jam=resep_obat.jam and "+
                        "detail_pemberian_obat.no_rawat=aturan_pakai.no_rawat and detail_pemberian_obat.kode_brng=aturan_pakai.kode_brng where resep_obat.no_resep=? order by databarang.kode_brng");
                    try {
    ...
    private void panggilform() {
        ...
        obat.isCek();
        obat.tampilobat2(tbPemisahan.getValueAt(tbPemisahan.getSelectedRow(),0).toString());
