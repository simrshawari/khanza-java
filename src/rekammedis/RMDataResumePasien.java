...
public final class RMDataResumePasien extends javax.swing.JDialog {
    ...
    public RMDataResumePasien(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Prosedur Sekunder 1","ICD9 Sek1","Prosedur Sekunder 2","ICD9 Sek2","Prosedur Sekunder 3","ICD9 Sek3","Obat-obatan waktu pulang/nasihat","Tanggal/Jam Keluar"
        }){
    ...
    private void initComponents() {
        ...
        jLabel8.setBounds(50, 127, 190, 23);
        ...
        BtnDokter5.setBounds(180, 150, 28, 23);

        label11.setText("Tanggal :");
        label11.setName("label11"); // NOI18N
        label11.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label11);
        label11.setBounds(790, 10, 60, 23);

        TglKeluar.setForeground(new java.awt.Color(50, 70, 50));
        TglKeluar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-01-2024 10:45:55" }));
        ...
        TglKeluar.setBounds(800, 40, 140, 23);
    ...
    private void MnLaporanResumeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResumeActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("tglkeluar",TglKeluar.getSelectedItem());
            tanggal="";
    ...
    */
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "resume_pasien.prosedur_utama,resume_pasien.kd_prosedur_utama,resume_pasien.prosedur_sekunder,resume_pasien.kd_prosedur_sekunder, "+
                    "resume_pasien.prosedur_sekunder2,resume_pasien.kd_prosedur_sekunder2,resume_pasien.prosedur_sekunder3,resume_pasien.kd_prosedur_sekunder3, "+
                    "resume_pasien.obat_pulang,resume_pasien.tanggal_keluar from resume_pasien inner join reg_periksa on resume_pasien.no_rawat=reg_periksa.no_rawat  "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on resume_pasien.kd_dokter=dokter.kd_dokter "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_prosedur_sekunder3"),rs.getString("obat_pulang"),rs.getString("tanggal_keluar") 
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Valid.SetTgl2(TglKeluar,tbObat.getValueAt(tbObat.getSelectedRow(),30).toString());
