...
public final class RMTriaseIGD extends javax.swing.JDialog {
    ...
    */
    ...
    public void setNoRm(String norwt,String norm,String namapasien) {
        ...
        TCari.setText(norwt);  
    //    TanggalKunjungan.setSelectedItem(Sequel.cariIsi("select DATE_FORMAT(reg_periksa.tgl_registrasi,' ',reg_periksa.jam_reg),%d-%m-%Y %H:%i:%s) from reg_periksa where reg_periksa.no_rawat=?",norwt));
    }
                        ...
                        try {
                            ...
                            if(rs2.next()){
                                htmlContent.append(                             
                                    "<tr class='isi'>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Pemeriksaan</td>"+
                                        "<td valign='middle' bgcolor='#969696' color='000000' align='center'>DOA</td>"+
                                    "</tr>");
                                rs2.beforeFirst();
                                while(rs2.next()){
                                    htmlContent.append(                             
