...
import rekammedis.RMHasilEndoskopiTenggorokan;
import rekammedis.RMHasilPemeriksaanEKG;
import rekammedis.RMHasilPemeriksaanMata;
import rekammedis.RMHasilPemeriksaanPSA;
...
import rekammedis.RMPenilaianAwalHemodialisis;
...
import surat.SuratKeteranganDiagnosis;
 ...
 * @author dosen
 */
public final class DlgKasirRalan_msani extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgKasirRalan_msani(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabModekasir=new DefaultTableModel(null,new String[]{
            "No.Reg","Dokter Dituju","No.RM","Pasien",
            "Poliklinik","Penanggung Jawab","Alamat P.J.","Hubungan P.J.",
            "Biaya Reg","Jenis Bayar","Status","No.Rawat","Tanggal",
            "Jam","Kode Dokter","Status Bayar","Stts Poli","Kd PJ","Kd Poli","No.Telp Pasien","NIK"}){
    ...
    private void initComponents() {
        ...
        MnPenilaianAwalKeperawatanHemodialisa = new javax.swing.JMenuItem();
        ...
        MnHasilPerawatanSaluranAkar = new javax.swing.JMenuItem();
        MnHasilEndoskopiTenggorokan = new javax.swing.JMenuItem();
        ...
        MnCetakKeteranganDiagnosis = new javax.swing.JMenuItem();
        MnCetakKeteranganBerobat = new javax.swing.JMenuItem();
        ...
        MnRiwayatPerawatanICareNIK2 = new javax.swing.JMenuItem();
        ...
        MnSuratSurat2 = new javax.swing.JMenu();
        ...
        MnPenilaianAwalKeperawatanHemodialisa.setBackground(new java.awt.Color(255, 255, 254));
        MnPenilaianAwalKeperawatanHemodialisa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPenilaianAwalKeperawatanHemodialisa.setForeground(new java.awt.Color(50, 50, 50));
        MnPenilaianAwalKeperawatanHemodialisa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPenilaianAwalKeperawatanHemodialisa.setText("Penilaian Awal Keperawatan Hemodialisa");
        MnPenilaianAwalKeperawatanHemodialisa.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPenilaianAwalKeperawatanHemodialisa.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPenilaianAwalKeperawatanHemodialisa.setName("MnPenilaianAwalKeperawatanHemodialisa"); // NOI18N
        MnPenilaianAwalKeperawatanHemodialisa.setPreferredSize(new java.awt.Dimension(310, 26));
        MnPenilaianAwalKeperawatanHemodialisa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPenilaianAwalKeperawatanHemodialisaActionPerformed(evt);
            }
        });
        MnAwalKeperawatan.add(MnPenilaianAwalKeperawatanHemodialisa);
        ...
        MnHasilPemeriksaanEKG.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnHasilPemeriksaanEKG.setForeground(new java.awt.Color(50, 50, 50));
        MnHasilPemeriksaanEKG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ...
        MnHasilPemeriksaanEKG.setName("MnHasilPemeriksaanEKG"); // NOI18N
        MnHasilPemeriksaanEKG.setPreferredSize(new java.awt.Dimension(200, 26));
        MnHasilPemeriksaanEKG.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnHasilPemeriksaanEKGActionPerformed(evt);
            }
        });
        MnRMRawatJalan.add(MnHasilPemeriksaanEKG);

        MnHasilPerawatanSaluranAkar.setBackground(new java.awt.Color(255, 255, 254));
        MnHasilPerawatanSaluranAkar.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnHasilPerawatanSaluranAkar.setForeground(new java.awt.Color(50, 50, 50));
        MnHasilPerawatanSaluranAkar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnHasilPerawatanSaluranAkar.setText("Hasil Perawatan Saluran Akar");
        MnHasilPerawatanSaluranAkar.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnHasilPerawatanSaluranAkar.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnHasilPerawatanSaluranAkar.setName("MnHasilPerawatanSaluranAkar"); // NOI18N
        MnHasilPerawatanSaluranAkar.setPreferredSize(new java.awt.Dimension(180, 26));
        MnHasilPerawatanSaluranAkar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnHasilPerawatanSaluranAkarActionPerformed(evt);
            }
        });
        MnRMRawatJalan.add(MnHasilPerawatanSaluranAkar);

        MnHasilEndoskopiTenggorokan.setBackground(new java.awt.Color(255, 255, 254));
        MnHasilEndoskopiTenggorokan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnHasilEndoskopiTenggorokan.setForeground(new java.awt.Color(50, 50, 50));
        MnHasilEndoskopiTenggorokan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnHasilEndoskopiTenggorokan.setText("Hasil Endoskopi Tenggorokan");
        MnHasilEndoskopiTenggorokan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnHasilEndoskopiTenggorokan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnHasilEndoskopiTenggorokan.setName("MnHasilEndoskopiTenggorokan"); // NOI18N
        MnHasilEndoskopiTenggorokan.setPreferredSize(new java.awt.Dimension(180, 26));
        MnHasilEndoskopiTenggorokan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnHasilEndoskopiTenggorokanActionPerformed(evt);
            }
        });
        MnRMRawatJalan.add(MnHasilEndoskopiTenggorokan);

        MnHasilEndoskopiHidung.setBackground(new java.awt.Color(255, 255, 254));
        MnHasilEndoskopiHidung.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnHasilEndoskopiHidung.setForeground(new java.awt.Color(50, 50, 50));
        MnHasilEndoskopiHidung.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ...
        MnHasilEndoskopiHidung.setName("MnHasilEndoskopiHidung"); // NOI18N
        MnHasilEndoskopiHidung.setPreferredSize(new java.awt.Dimension(180, 26));
        MnHasilEndoskopiHidung.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnHasilEndoskopiHidungActionPerformed(evt);
            }
        });
        ...
        MnCetakKeteranganDiagnosis.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakKeteranganDiagnosis.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakKeteranganDiagnosis.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakKeteranganDiagnosis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakKeteranganDiagnosis.setText("Surat Keterangan Diagnosis");
        MnCetakKeteranganDiagnosis.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnCetakKeteranganDiagnosis.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnCetakKeteranganDiagnosis.setName("MnCetakKeteranganDiagnosis"); // NOI18N
        MnCetakKeteranganDiagnosis.setPreferredSize(new java.awt.Dimension(250, 26));
        MnCetakKeteranganDiagnosis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakKeteranganDiagnosisActionPerformed(evt);
            }
        });
        MnSuratSurat.add(MnCetakKeteranganDiagnosis);

        MnCetakKeteranganBerobat.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakKeteranganBerobat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakKeteranganBerobat.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakKeteranganBerobat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakKeteranganBerobat.setText("Surat Keterangan Berobat");
        MnCetakKeteranganBerobat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnCetakKeteranganBerobat.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnCetakKeteranganBerobat.setName("MnCetakKeteranganBerobat"); // NOI18N
        MnCetakKeteranganBerobat.setPreferredSize(new java.awt.Dimension(250, 26));
        MnCetakKeteranganBerobat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakKeteranganBerobatActionPerformed(evt);
            }
        });
        MnSuratSurat.add(MnCetakKeteranganBerobat);
        ...
        MnRiwayatPerawatanICareNIK2.setBackground(new java.awt.Color(255, 255, 254));
        MnRiwayatPerawatanICareNIK2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRiwayatPerawatanICareNIK2.setForeground(new java.awt.Color(50, 50, 50));
        MnRiwayatPerawatanICareNIK2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnRiwayatPerawatanICareNIK2.setText("Cek Riwayat Perawatan ICare BPJS Via NIK");
        MnRiwayatPerawatanICareNIK2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRiwayatPerawatanICareNIK2.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRiwayatPerawatanICareNIK2.setName("MnRiwayatPerawatanICareNIK2"); // NOI18N
        MnRiwayatPerawatanICareNIK2.setPreferredSize(new java.awt.Dimension(320, 26));
        MnRiwayatPerawatanICareNIK2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRiwayatPerawatanICareNIK2ActionPerformed(evt);
            }
        });
        MnBridging.add(MnRiwayatPerawatanICareNIK2);
        ...
        MnSuratSurat2.setBackground(new java.awt.Color(255, 255, 254));
        MnSuratSurat2.setForeground(new java.awt.Color(50, 50, 50));
        MnSuratSurat2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSuratSurat2.setText("Surat-Surat");
        MnSuratSurat2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSuratSurat2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnSuratSurat2.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnSuratSurat2.setName("MnSuratSurat2"); // NOI18N
        MnSuratSurat2.setPreferredSize(new java.awt.Dimension(240, 26));
        ...
        MnCetakSuratSakit2.setText("Surat Cuti Sakit");
        ...
        MnSuratSurat2.add(MnCetakSuratSakit2);

        jPopupMenu2.add(MnSuratSurat2);
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2024" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2024" }));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2024" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2024" }));
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void MnCetakKeteranganDiagnosisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakKeteranganDiagnosisActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data pasien sudah habis...!!!!");
            TNoRw.requestFocus();
        }else if(TPasienCari.getText().trim().equals("")){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                SuratKeteranganDiagnosis resume=new SuratKeteranganDiagnosis(null,false);
                resume.isCek();
                resume.emptTeks();
                resume.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                resume.setLocationRelativeTo(internalFrame1);
    ...
    }//GEN-LAST:event_MnCetakKeteranganDiagnosisActionPerformed

    private void MnCetakKeteranganBerobatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakKeteranganBerobatActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data pasien sudah habis...!!!!");
            TNoRw.requestFocus();
        }else if(TPasienCari.getText().trim().equals("")){
    ...
    }//GEN-LAST:event_MnCetakKeteranganBerobatActionPerformed
    ...
    private void MnRiwayatPerawatanICareNIK2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRiwayatPerawatanICareNIK2ActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    }//GEN-LAST:event_MnRiwayatPerawatanICareNIK2ActionPerformed
    ...
    private void MnPenilaianAwalKeperawatanHemodialisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianAwalKeperawatanHemodialisaActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMPenilaianAwalHemodialisis form=new RMPenilaianAwalHemodialisis(null,false);
                form.isCek();
                form.setNoRm(TNoRw.getText(),DTPCari2.getDate());
                form.emptTeks();
                form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    }//GEN-LAST:event_MnPenilaianAwalKeperawatanHemodialisaActionPerformed

    private void BtnReviewSEPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnReviewSEPActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    }//GEN-LAST:event_BtnReviewSEPActionPerformed

    private void BtnReviewSEPKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnReviewSEPKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnReviewSEPKeyPressed
    ...
    private void MnHasilPemeriksaanEKGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHasilPemeriksaanEKGActionPerformed
         if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    }//GEN-LAST:event_MnHasilPemeriksaanEKGActionPerformed

    private void MnHasilPerawatanSaluranAkarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHasilPerawatanSaluranAkarActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMHasilPemeriksaanPSA form=new RMHasilPemeriksaanPSA(null,false);
                form.isCek();
                form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                form.setLocationRelativeTo(internalFrame1);
                form.setVisible(true);
    ...
    }//GEN-LAST:event_MnHasilPerawatanSaluranAkarActionPerformed

    private void MnHasilEndoskopiTenggorokanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHasilEndoskopiTenggorokanActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMHasilEndoskopiTenggorokan form=new RMHasilEndoskopiTenggorokan(null,false);
                form.isCek();
                form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                form.setLocationRelativeTo(internalFrame1);
                form.setVisible(true);
    ...
    }//GEN-LAST:event_MnHasilEndoskopiTenggorokanActionPerformed

    private void MnHasilEndoskopiHidungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHasilEndoskopiHidungActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    }//GEN-LAST:event_MnHasilEndoskopiHidungActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKasirRalan_msani dialog = new DlgKasirRalan_msani(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JMenuItem MnCetakKeteranganBerobat;
    private javax.swing.JMenuItem MnCetakKeteranganDiagnosis;
    ...
    private javax.swing.JMenuItem MnHasilEndoskopiHidung;
    private javax.swing.JMenuItem MnHasilEndoskopiTenggorokan;
    private javax.swing.JMenuItem MnHasilPemeriksaanEKG;
    private javax.swing.JMenuItem MnHasilPemeriksaanUSG;
    private javax.swing.JMenuItem MnHasilPerawatanSaluranAkar;
    ...
    private javax.swing.JMenuItem MnPenilaianAwalKeperawatanHemodialisa;
    ...
    private javax.swing.JMenuItem MnRiwayatPerawatanICareNIK2;
    ...
    private javax.swing.JMenu MnSuratSurat2;
    ...
    private void tampilkasir() {     
        ...
        try{   
            ...
            pskasir=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                "reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"+
                "reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.biaya_reg,reg_periksa.stts,penjab.png_jawab,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur, "+
                "reg_periksa.status_bayar,reg_periksa.status_poli,reg_periksa.kd_pj,reg_periksa.kd_poli,pasien.no_tlp,pasien.no_ktp,pasien.jk,DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y')as tgl_lahir "+
                "from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join penjab on reg_periksa.kd_pj=penjab.kd_pj where  "+
            ...
            try{
                ...
                while(rskasir.next()){
                    tabModekasir.addRow(new String[] {
                        rskasir.getString(1),rskasir.getString(6),rskasir.getString(7),rskasir.getString(8)+" ("+rskasir.getString("jk")+")"+" ("+rskasir.getString("tgl_lahir")+")"+" ("+rskasir.getString("umur")+")",
                        ...
                        rskasir.getString("jam_reg"),rskasir.getString(5),rskasir.getString("status_bayar"),rskasir.getString("status_poli"),
    ...
    private void getDatakasir() {
        if(tbKasirRalan.getSelectedRow()!= -1){
            ...
            RiwayatAlergi.setText(Sequel.cariIsi("select catatan from catatan_pasien_alergi where no_rkm_medis=?",TNoRMCari.getText()));
        }
    }
