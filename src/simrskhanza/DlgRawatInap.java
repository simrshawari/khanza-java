...
import inventory.DlgTemplatePemberianObatRi;
...
import rekammedis.RMCari5SOAPTerakhirAdime;
...
import rekammedis.SwingHTMLBrowser;
...
public final class DlgRawatInap extends javax.swing.JDialog {
    private final DefaultTableModel tabModeDr,tabModePr,tabModeDrPr,
            tabModePemeriksaan,tabModeObstetri,tabModeGinekologi,tabModePemeriksaanSbar,tabModePemeriksaanTbak,tabModePemeriksaanAdime,tabModePemeriksaanInfus;
    ...
    public  DlgCariPegawai pegawaiadime=new DlgCariPegawai(null,false);
    ...
    private RMCari5SOAPTerakhirAdime soapterakhiradime=new RMCari5SOAPTerakhirAdime(null,false);
    private PreparedStatement ps,ps2,ps3,ps4,ps5,psrekening,ps6,ps7,ps9;
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabModePemeriksaanTbak=new DefaultTableModel(null,new Object[]{
            "P","No.Rawat","No.R.M.","Nama Pasien","Tgl.Rawat","Jam",
            "Instruksi","Background","Assesment","Recommendation","NIP","Dokter/Paramedis","Profesi/Jabatan","Status Verifikasi"}){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if (colIndex==0) {
                    a=true;
        ...
        tabModePemeriksaanAdime=new DefaultTableModel(null,new Object[]{
            "P","No.Rawat","No.R.M.","Nama Pasien","Tgl.Rawat","Jam","Suhu(C)","Tensi","Nadi(/menit)",
        ...
        tbPemeriksaan1.setModel(tabModePemeriksaanAdime);
        tbPemeriksaan1.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbPemeriksaan1.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 25; i++) {
            TableColumn column = tbPemeriksaan1.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(20);
            }else if(i==1){
                column.setPreferredWidth(105);
        ...
        tbPemeriksaan1.setDefaultRenderer(Object.class, new WarnaTable());
        
        tabModePemeriksaanInfus=new DefaultTableModel(null,new Object[]{
            "P","No.Rawat","No.R.M.","Nama Pasien","Tgl.Rawat","Jam",
            "Jenis Cairan","Obat yg Dicampur","Infus Ke","Tetesan","Jam Mulai","Jam Henti","Kondisi Infus","Petugas"}){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if (colIndex==0) {
                    a=true;
        ...
        tbPemeriksaanInfus.setModel(tabModePemeriksaanInfus);
        tbPemeriksaanInfus.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbPemeriksaanInfus.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 10; i++) {
            TableColumn column = tbPemeriksaanInfus.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(20);
            }else if(i==1){
                column.setPreferredWidth(105);
        ...
        tbPemeriksaanInfus.setDefaultRenderer(Object.class, new WarnaTable());
        ...
        pegawaiadime.addWindowListener(new WindowListener() {
            @Override
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgRawatJalan")){
                    if(pegawaiadime.getTable().getSelectedRow()!= -1){   
                        
                        KdPeg1.setText(pegawaiadime.getTable().getValueAt(pegawaiadime.getTable().getSelectedRow(),0).toString());
                        TPegawai1.setText(pegawaiadime.getTable().getValueAt(pegawaiadime.getTable().getSelectedRow(),1).toString());
                        Jabatan3.setText(pegawaiadime.getTable().getValueAt(pegawaiadime.getTable().getSelectedRow(),3).toString());
                        KdPeg1.requestFocus();
                ...
                if(akses.getform().equals("DlgRawatInap")){
                    if(pegawai.getTable().getSelectedRow()!= -1){ 
                        ...
                        KdPeg.requestFocus();    
                            ...
                            KdPeg6.setText(pegawai.getTable().getValueAt(pegawai.getTable().getSelectedRow(),0).toString());
                            TPegawai6.setText(pegawai.getTable().getValueAt(pegawai.getTable().getSelectedRow(),1).toString());
                            Jabatan4.setText(pegawai.getTable().getValueAt(pegawai.getTable().getSelectedRow(),3).toString());
                            KdPeg6.requestFocus(); 
                        }                       
    ...
    private void initComponents() {
        ...
        CheklistFisioterapi = new javax.swing.JMenuItem();
        ...
        tbPemeriksaan1 = new widget.Table();
        ...
        TPenilaian1 = new widget.TextArea();
        ...
        Jabatan3 = new widget.TextBox();
        jLabel110 = new widget.Label();
        jLabel111 = new widget.Label();
        scrollPane19 = new widget.ScrollPane();
        TInstruksi1 = new widget.TextArea();
        ...
        TEvaluasi1 = new widget.TextArea();
        ...
        tbPemeriksaanInfus = new widget.Table();
        ...
        TSituation2 = new widget.TextArea();
        scrollPane22 = new widget.ScrollPane();
        TBackground2 = new widget.TextArea();
        jLabel106 = new widget.Label();
        jLabel116 = new widget.Label();
        scrollPane23 = new widget.ScrollPane();
        TAssesment2 = new widget.TextArea();
        jLabel119 = new widget.Label();
        jLabel120 = new widget.Label();
        scrollPane24 = new widget.ScrollPane();
        TRecommendation2 = new widget.TextArea();
        jLabel121 = new widget.Label();
        KdPeg6 = new widget.TextBox();
        TPegawai6 = new widget.TextBox();
        BtnSeekPegawai4 = new widget.Button();
        Jabatan4 = new widget.TextBox();
        jLabel122 = new widget.Label();
        TPegawai7 = new widget.TextBox();
        KdPeg7 = new widget.TextBox();
        jLabel123 = new widget.Label();
        jLabel124 = new widget.Label();
        jLabel125 = new widget.Label();
        cmbMnt1 = new widget.ComboBox();
        jLabel126 = new widget.Label();
        Jabatan5 = new widget.TextBox();
        ...
        BtnTemplateObat = new widget.Button();
        ...
        CheklistFisioterapi.setText("Checklist Harian Fisioterapi Rawat Inap");
        CheklistFisioterapi.setName("CheklistFisioterapi"); // NOI18N
        jPopupMenu1.add(CheklistFisioterapi);
        ...
        BtnInputTerimaPasienAntarRuang.setText("Grafik TTV");
        ...
        BtnInputTerimaPasienAntarRuang.setBounds(920, 130, 160, 30);
        ...
        BtnInputResume.setBounds(920, 10, 160, 30);
        ...
        BtnInputJadwalOP1.setBounds(920, 160, 160, 30);
        ...
        Scroll7.setViewportView(tbPemeriksaanTbak);
        ...
        scrollPane11.setBounds(20, 80, 420, 150);
        ...
        BtnVerifSbar1.setBounds(450, 80, 40, 23);
        ...
        jLabel87.setBounds(490, 120, 200, 23);
        ...
        panelGlass17.add(jLabel100);
        jLabel100.setBounds(490, 80, 200, 23);
        ...
        tbPemeriksaan1.setAutoCreateRowSorter(true);
        tbPemeriksaan1.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbPemeriksaan1.setName("tbPemeriksaan1"); // NOI18N
        tbPemeriksaan1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbPemeriksaan1MouseClicked(evt);
            }
        });
        tbPemeriksaan1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbPemeriksaan1KeyReleased(evt);
            }
        });
        Scroll8.setViewportView(tbPemeriksaan1);
        ...
        PanelInput6.setPreferredSize(new java.awt.Dimension(192, 273));
        ...
        jLabel17.setText("Suhu (°C) :");
        jLabel17.setName("jLabel17"); // NOI18N
        panelGlass18.add(jLabel17);
        jLabel17.setBounds(0, 190, 70, 23);

        TSuhu1.setFocusTraversalPolicyProvider(true);
        TSuhu1.setName("TSuhu1"); // NOI18N
        TSuhu1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TSuhu1ActionPerformed(evt);
            }
        });
        ...
        panelGlass18.add(TSuhu1);
        TSuhu1.setBounds(80, 190, 55, 23);

        jLabel69.setText("Tensi :");
        jLabel69.setName("jLabel69"); // NOI18N
        panelGlass18.add(jLabel69);
        jLabel69.setBounds(0, 220, 70, 23);
        ...
        panelGlass18.add(TTensi1);
        TTensi1.setBounds(80, 220, 55, 23);

        jLabel101.setText("Berat (Kg) :");
        jLabel101.setName("jLabel101"); // NOI18N
        panelGlass18.add(jLabel101);
        jLabel101.setBounds(300, 190, 79, 23);
        ...
        panelGlass18.add(TNadi1);
        TNadi1.setBounds(380, 220, 55, 23);
        ...
        panelGlass18.add(TTinggi1);
        TTinggi1.setBounds(240, 190, 55, 23);

        jLabel103.setText("Tinggi Badan (Cm) :");
        jLabel103.setName("jLabel103"); // NOI18N
        panelGlass18.add(jLabel103);
        jLabel103.setBounds(140, 190, 100, 23);

        jLabel104.setText("Alergi :");
        jLabel104.setName("jLabel104"); // NOI18N
        panelGlass18.add(jLabel104);
        jLabel104.setBounds(500, 10, 90, 23);
        ...
        panelGlass18.add(TAlergi1);
        TAlergi1.setBounds(600, 10, 360, 23);

        jLabel105.setText("Respirasi (/menit) :");
        jLabel105.setName("jLabel105"); // NOI18N
        panelGlass18.add(jLabel105);
        jLabel105.setBounds(140, 220, 100, 23);
        ...
        panelGlass18.add(TRespirasi1);
        TRespirasi1.setBounds(240, 220, 55, 23);

        scrollPane15.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane15.setName("scrollPane15"); // NOI18N

        TKeluhan1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        scrollPane15.setViewportView(TKeluhan1);

        panelGlass18.add(scrollPane15);
        scrollPane15.setBounds(110, 70, 360, 50);

        scrollPane16.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane16.setName("scrollPane16"); // NOI18N

        TPemeriksaan1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        scrollPane16.setViewportView(TPemeriksaan1);

        panelGlass18.add(scrollPane16);
        scrollPane16.setBounds(110, 130, 360, 50);

        scrollPane17.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane17.setName("scrollPane17"); // NOI18N

        TPenilaian1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TPenilaian1.setColumns(20);
        TPenilaian1.setRows(5);
        TPenilaian1.setName("TPenilaian1"); // NOI18N
        TPenilaian1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TPenilaian1KeyPressed(evt);
            }
        });
        scrollPane17.setViewportView(TPenilaian1);

        panelGlass18.add(scrollPane17);
        scrollPane17.setBounds(600, 40, 360, 50);

        jLabel107.setText("Intervensi :");
        jLabel107.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel107.setName("jLabel107"); // NOI18N
        panelGlass18.add(jLabel107);
        jLabel107.setBounds(480, 50, 110, 23);

        jLabel108.setText("Monitoring :");
        jLabel108.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel108.setName("jLabel108"); // NOI18N
        panelGlass18.add(jLabel108);
        jLabel108.setBounds(500, 110, 90, 23);
        ...
        scrollPane18.setViewportView(TindakLanjut1);

        panelGlass18.add(scrollPane18);
        scrollPane18.setBounds(600, 100, 360, 47);

        jLabel109.setText("Dilakukan :");
        jLabel109.setName("jLabel109"); // NOI18N
        panelGlass18.add(jLabel109);
        jLabel109.setBounds(0, 10, 70, 23);

        KdPeg1.setHighlighter(null);
        KdPeg1.setName("KdPeg1"); // NOI18N
        KdPeg1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KdPeg1ActionPerformed(evt);
            }
        });
        ...
        panelGlass18.add(BtnSeekPegawai3);
        BtnSeekPegawai3.setBounds(440, 10, 28, 23);

        Jabatan3.setEditable(false);
        Jabatan3.setHighlighter(null);
        Jabatan3.setName("Jabatan3"); // NOI18N
        panelGlass18.add(Jabatan3);
        Jabatan3.setBounds(193, 40, 250, 23);

        jLabel110.setText("Profesi / Jabatan / Departemen :");
        jLabel110.setName("jLabel110"); // NOI18N
        panelGlass18.add(jLabel110);
        jLabel110.setBounds(0, 40, 190, 23);

        jLabel111.setText("Evaluasi :");
        jLabel111.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel111.setName("jLabel111"); // NOI18N
        panelGlass18.add(jLabel111);
        jLabel111.setBounds(490, 170, 100, 23);
        ...
        TInstruksi1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TInstruksi1.setColumns(20);
        TInstruksi1.setRows(5);
        TInstruksi1.setName("TInstruksi1"); // NOI18N
        TInstruksi1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TInstruksi1KeyPressed(evt);
            }
        });
        scrollPane19.setViewportView(TInstruksi1);

        panelGlass18.add(scrollPane19);
        scrollPane19.setBounds(600, 160, 360, 50);
        ...
        panelGlass18.add(SpO3);
        SpO3.setBounds(80, 250, 42, 23);
        ...
        panelGlass18.add(TGCS1);
        TGCS1.setBounds(200, 250, 42, 23);

        jLabel114.setText("Kesadaran :");
        jLabel114.setName("jLabel114"); // NOI18N
        panelGlass18.add(jLabel114);
        jLabel114.setBounds(240, 250, 70, 23);
        ...
        panelGlass18.add(cmbKesadaran1);
        cmbKesadaran1.setBounds(310, 250, 126, 23);
        ...
        TEvaluasi1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TEvaluasi1.setColumns(20);
        TEvaluasi1.setRows(5);
        TEvaluasi1.setName("TEvaluasi1"); // NOI18N
        TEvaluasi1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TEvaluasi1KeyPressed(evt);
            }
        });
        scrollPane20.setViewportView(TEvaluasi1);

        panelGlass18.add(scrollPane20);
        scrollPane20.setBounds(600, 220, 360, 50);

        jLabel115.setText("Instruksi PPA :");
        jLabel115.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel115.setName("jLabel115"); // NOI18N
        panelGlass18.add(jLabel115);
        jLabel115.setBounds(470, 230, 120, 23);

        Btn5Soap3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        Btn5Soap3.setMnemonic('4');
        Btn5Soap3.setToolTipText("ALt+4");
        ...
        panelGlass18.add(Btn5Soap3);
        Btn5Soap3.setBounds(440, 40, 28, 23);

        jLabel117.setText("Asesmen :");
        jLabel117.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel117.setName("jLabel117"); // NOI18N
        panelGlass18.add(jLabel117);
        jLabel117.setBounds(10, 80, 90, 23);

        jLabel118.setText("Diagnosis :");
        jLabel118.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel118.setName("jLabel118"); // NOI18N
        panelGlass18.add(jLabel118);
        jLabel118.setBounds(0, 140, 100, 23);

        PanelInput6.add(panelGlass18, java.awt.BorderLayout.CENTER);

        internalFrame10.add(PanelInput6, java.awt.BorderLayout.PAGE_START);

        TabRawat.addTab("ADIME GIZI", internalFrame10);
        ...
        tbPemeriksaanInfus.setAutoCreateRowSorter(true);
        tbPemeriksaanInfus.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbPemeriksaanInfus.setName("tbPemeriksaanInfus"); // NOI18N
        tbPemeriksaanInfus.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbPemeriksaanInfusMouseClicked(evt);
            }
        });
        tbPemeriksaanInfus.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbPemeriksaanInfusKeyReleased(evt);
            }
        });
        Scroll9.setViewportView(tbPemeriksaanInfus);
        ...
        PanelInput7.setPreferredSize(new java.awt.Dimension(192, 273));
        ...
        TSituation2.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TSituation2.setColumns(20);
        TSituation2.setRows(5);
        TSituation2.setName("TSituation2"); // NOI18N
        TSituation2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TSituation2KeyPressed(evt);
            }
        });
        scrollPane21.setViewportView(TSituation2);

        panelGlass19.add(scrollPane21);
        scrollPane21.setBounds(120, 50, 190, 40);
        ...
        TBackground2.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TBackground2.setColumns(20);
        TBackground2.setRows(5);
        TBackground2.setName("TBackground2"); // NOI18N
        TBackground2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TBackground2KeyPressed(evt);
            }
        });
        scrollPane22.setViewportView(TBackground2);

        panelGlass19.add(scrollPane22);
        scrollPane22.setBounds(120, 100, 190, 40);

        jLabel106.setText("Jenis Cairan Infus :");
        jLabel106.setName("jLabel106"); // NOI18N
        panelGlass19.add(jLabel106);
        jLabel106.setBounds(0, 50, 110, 23);

        jLabel116.setText("Obat Yang Dicampur :");
        jLabel116.setName("jLabel116"); // NOI18N
        panelGlass19.add(jLabel116);
        jLabel116.setBounds(0, 100, 110, 23);
        ...
        TAssesment2.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TAssesment2.setColumns(20);
        TAssesment2.setRows(5);
        TAssesment2.setName("TAssesment2"); // NOI18N
        TAssesment2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TAssesment2KeyPressed(evt);
            }
        });
        scrollPane23.setViewportView(TAssesment2);

        panelGlass19.add(scrollPane23);
        scrollPane23.setBounds(120, 150, 190, 40);

        jLabel119.setText("Tetesan (/menit) :");
        jLabel119.setName("jLabel119"); // NOI18N
        panelGlass19.add(jLabel119);
        jLabel119.setBounds(0, 150, 110, 23);

        jLabel120.setText("Waktu Dihentikan :");
        jLabel120.setName("jLabel120"); // NOI18N
        panelGlass19.add(jLabel120);
        jLabel120.setBounds(630, 100, 100, 23);
        ...
        TRecommendation2.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TRecommendation2.setColumns(20);
        TRecommendation2.setRows(5);
        TRecommendation2.setName("TRecommendation2"); // NOI18N
        TRecommendation2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TRecommendation2KeyPressed(evt);
            }
        });
        scrollPane24.setViewportView(TRecommendation2);

        panelGlass19.add(scrollPane24);
        scrollPane24.setBounds(460, 50, 190, 40);

        jLabel121.setText("Dilakukan :");
        jLabel121.setName("jLabel121"); // NOI18N
        panelGlass19.add(jLabel121);
        jLabel121.setBounds(0, 10, 70, 23);

        KdPeg6.setHighlighter(null);
        KdPeg6.setName("KdPeg6"); // NOI18N
        KdPeg6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KdPeg6ActionPerformed(evt);
            }
        });
        KdPeg6.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KdPeg6KeyPressed(evt);
            }
        });
        panelGlass19.add(KdPeg6);
        KdPeg6.setBounds(70, 10, 115, 23);

        TPegawai6.setEditable(false);
        TPegawai6.setHighlighter(null);
        TPegawai6.setName("TPegawai6"); // NOI18N
        TPegawai6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TPegawai6ActionPerformed(evt);
            }
        });
        panelGlass19.add(TPegawai6);
        TPegawai6.setBounds(190, 10, 212, 23);
        ...
        panelGlass19.add(BtnSeekPegawai4);
        BtnSeekPegawai4.setBounds(405, 10, 28, 23);

        Jabatan4.setEditable(false);
        Jabatan4.setHighlighter(null);
        Jabatan4.setName("Jabatan4"); // NOI18N
        Jabatan4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Jabatan4ActionPerformed(evt);
            }
        });
        panelGlass19.add(Jabatan4);
        Jabatan4.setBounds(640, 10, 160, 23);

        jLabel122.setText("Profesi / Jabatan / Departemen :");
        jLabel122.setName("jLabel122"); // NOI18N
        panelGlass19.add(jLabel122);
        jLabel122.setBounds(440, 10, 190, 23);

        TPegawai7.setEditable(false);
        TPegawai7.setHighlighter(null);
        TPegawai7.setName("TPegawai7"); // NOI18N
        panelGlass19.add(TPegawai7);
        TPegawai7.setBounds(310, 610, 212, 23);

        KdPeg7.setHighlighter(null);
        KdPeg7.setName("KdPeg7"); // NOI18N
        KdPeg7.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KdPeg7KeyPressed(evt);
            }
        });
        panelGlass19.add(KdPeg7);
        KdPeg7.setBounds(190, 610, 115, 23);

        jLabel123.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel123.setText("Dokter DPJP Utama");
        jLabel123.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel123.setName("jLabel123"); // NOI18N
        panelGlass19.add(jLabel123);
        jLabel123.setBounds(60, 610, 140, 23);

        jLabel124.setText("Konsundisi Infus :");
        jLabel124.setName("jLabel124"); // NOI18N
        panelGlass19.add(jLabel124);
        jLabel124.setBounds(350, 50, 100, 23);

        jLabel125.setText("Infus Ke :");
        jLabel125.setName("jLabel125"); // NOI18N
        panelGlass19.add(jLabel125);
        jLabel125.setBounds(350, 140, 100, 23);
        ...
        panelGlass19.add(cmbMnt1);
        cmbMnt1.setBounds(460, 140, 62, 23);

        jLabel126.setText("Waktu Mulai :");
        jLabel126.setName("jLabel126"); // NOI18N
        panelGlass19.add(jLabel126);
        jLabel126.setBounds(350, 100, 100, 23);

        Jabatan5.setEditable(false);
        Jabatan5.setHighlighter(null);
        Jabatan5.setName("Jabatan5"); // NOI18N
        Jabatan5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Jabatan5ActionPerformed(evt);
            }
        });
        panelGlass19.add(Jabatan5);
        Jabatan5.setBounds(640, 10, 160, 23);

        PanelInput7.add(panelGlass19, java.awt.BorderLayout.CENTER);

        internalFrame11.add(PanelInput7, java.awt.BorderLayout.PAGE_START);

        TabRawat.addTab("Monitoring Cairan Infus", internalFrame11);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-06-2025" }));
        ...
        ScrollMenu.setPreferredSize(new java.awt.Dimension(500, 43));

        FormMenu.setBackground(new java.awt.Color(255, 255, 255));
        FormMenu.setBorder(null);
        FormMenu.setName("FormMenu"); // NOI18N
        FormMenu.setPreferredSize(new java.awt.Dimension(300, 43));
        ...
        BtnVerifikasiSBAR.setMaximumSize(new java.awt.Dimension(96, 18));
        BtnVerifikasiSBAR.setMinimumSize(new java.awt.Dimension(96, 18));
        ...
        BtnVerifikasiTBAK.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnVerifikasiTBAK.setText("Verifikasi TBAK");
        BtnVerifikasiTBAK.setFocusPainted(false);
        BtnVerifikasiTBAK.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnVerifikasiTBAK.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnVerifikasiTBAK.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnVerifikasiTBAK.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnVerifikasiTBAK.setName("BtnVerifikasiTBAK"); // NOI18N
        BtnVerifikasiTBAK.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnVerifikasiTBAK.setRoundRect(false);
        BtnVerifikasiTBAK.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnVerifikasiTBAKActionPerformed(evt);
            }
        });
        FormMenu.add(BtnVerifikasiTBAK);
        ...
        BtnTemplateObat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnTemplateObat.setText("Template Pemberian Obat");
        BtnTemplateObat.setFocusPainted(false);
        BtnTemplateObat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnTemplateObat.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnTemplateObat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnTemplateObat.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnTemplateObat.setName("BtnTemplateObat"); // NOI18N
        BtnTemplateObat.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnTemplateObat.setRoundRect(false);
        BtnTemplateObat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnTemplateObatActionPerformed(evt);
            }
        });
        BtnTemplateObat.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnTemplateObatKeyPressed(evt);
            }
        });
        FormMenu.add(BtnTemplateObat);
        ...
        BtnAwalMedisKandungan1.setText("Awal Medis Neonatus");
            ...
            switch (TabRawat.getSelectedIndex()) {
                ...
                if((!TSituation1.getText().trim().equals(""))||(!TBackground1.getText().trim().equals(""))||(!TAssesment1.getText().trim().equals(""))||
                        ...
                        if(KdPeg4.getText().trim().equals("")||TPegawai4.getText().trim().equals("")){
                            ...
                            if(akses.getkode().equals("Admin Utama")){
                                Sequel.menyimpan("pemeriksaan_ranap_tbak","?,?,?,?,?,?,?,?","Data",8,new String[]{
                                    TNoRw.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),                      
                                    TSituation1.getText(),TBackground1.getText(),TAssesment1.getText(),TRecommendation1.getText(),KdPeg4.getText()
                                });
                ...
                case 8:
                if((!TKeluhan1.getText().trim().equals(""))||(!TPemeriksaan1.getText().trim().equals(""))||(!TSuhu1.getText().trim().equals(""))||
                            (!TTensi1.getText().trim().equals(""))||(!TAlergi.getText().trim().equals(""))||(!TTinggi1.getText().trim().equals(""))||
                            (!TBerat1.getText().trim().equals(""))||(!TRespirasi1.getText().trim().equals(""))||(!TNadi1.getText().trim().equals(""))||
                            (!TGCS1.getText().trim().equals(""))||(!TindakLanjut1.getText().trim().equals(""))||(!TPenilaian1.getText().trim().equals(""))||
                            (!TInstruksi1.getText().trim().equals(""))||(!SpO3.getText().trim().equals(""))||(!TEvaluasi1.getText().trim().equals(""))){
                        if(KdPeg6.getText().trim().equals("")||TPegawai6.getText().trim().equals("")){
                            Valid.textKosong(KdPeg6,"Dokter/Paramedis masih kosong...!!");
                        }else{
                            if(akses.getkode().equals("Admin Utama")){
                                Sequel.menyimpan("pemeriksaan_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",20,new String[]{
                                    ...
                                    cmbKesadaran1.getSelectedItem().toString(),TKeluhan1.getText(),TPemeriksaan1.getText(),TAlergi1.getText(),
                                    TPenilaian1.getText(),TindakLanjut1.getText(),TInstruksi1.getText(),TEvaluasi1.getText(),KdPeg1.getText()
                                });
                    ...
                    case 9:
                    if((!TSituation2.getText().trim().equals(""))||(!TBackground2.getText().trim().equals(""))||(!TAssesment2.getText().trim().equals(""))||
                            (!TRecommendation2.getText().trim().equals(""))){
                        if(KdPeg6.getText().trim().equals("")||TPegawai6.getText().trim().equals("")){
                            Valid.textKosong(KdPeg6,"Dokter/Paramedis masih kosong...!!");
                        }else{
                            if(akses.getkode().equals("Admin Utama")){
                                Sequel.menyimpan("pemeriksaan_ranap_infus","?,?,?,?,?,?,?,?,?,?,?","Data",11,new String[]{
                                    TNoRw.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),                      
                                    TSituation2.getText(),TBackground2.getText(),TAssesment2.getText(),TRecommendation2.getText(),Valid.SetTgl(DTPCari3.getSelectedItem()+""),Valid.SetTgl(DTPCari4.getSelectedItem()+""),Valid.SetTgl(cmbMnt1.getSelectedItem()+""),KdPeg4.getText()
                                });
                                tampilPemeriksaanInfus();
                                BtnBatalActionPerformed(evt);
                            }else{
                                if(akses.getkode().equals(KdPeg4.getText())){
                                    Sequel.menyimpan("pemeriksaan_ranap_infus","?,?,?,?,?,?,?,?,?,?,?","Data",11,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        switch (TabRawat.getSelectedIndex()) {
            ...
            case 6:
                ...
                case 8:
                if(tabModePemeriksaanAdime.getRowCount()==0){
                    JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
                    TNoRw.requestFocus();
                }else{
                    for(i=0;i<tbPemeriksaan1.getRowCount();i++){
                        if(tbPemeriksaan1.getValueAt(i,0).toString().equals("true")){
                            if(akses.getkode().equals("Admin Utama")){
                                Sequel.queryu("delete from pemeriksaan_ranap where no_rawat='"+tbPemeriksaan1.getValueAt(i,1).toString()+
                                        "' and tgl_perawatan='"+tbPemeriksaan1.getValueAt(i,4).toString()+
                                        "' and jam_rawat='"+tbPemeriksaan1.getValueAt(i,5).toString()+"' ");
                            }else{
                                if(akses.getkode().equals(tbPemeriksaan1.getValueAt(i,22).toString())){
                                    Sequel.queryu("delete from pemeriksaan_ranap where no_rawat='"+tbPemeriksaan1.getValueAt(i,1).toString()+
                                            "' and tgl_perawatan='"+tbPemeriksaan1.getValueAt(i,4).toString()+
                                            "' and jam_rawat='"+tbPemeriksaan1.getValueAt(i,5).toString()+"' ");
                                }else{
                ...
                case 9:
                if(tabModePemeriksaanInfus.getRowCount()==0){
                    JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
                    TNoRw.requestFocus();
                }else{
                    for(i=0;i<tbPemeriksaanInfus.getRowCount();i++){
                        if(tbPemeriksaanInfus.getValueAt(i,0).toString().equals("true")){
                            if(akses.getkode().equals("Admin Utama")){
                                Sequel.queryu("delete from pemeriksaan_ranap where no_rawat='"+tbPemeriksaanInfus.getValueAt(i,1).toString()+
                                        "' and tgl_perawatan='"+tbPemeriksaanInfus.getValueAt(i,4).toString()+
                                        "' and jam_rawat='"+tbPemeriksaanInfus.getValueAt(i,5).toString()+"' ");
                            }else{
                                if(akses.getkode().equals(tbPemeriksaanInfus.getValueAt(i,22).toString())){
                                    Sequel.queryu("delete from pemeriksaan_ranap where no_rawat='"+tbPemeriksaanInfus.getValueAt(i,1).toString()+
                                            "' and tgl_perawatan='"+tbPemeriksaanInfus.getValueAt(i,4).toString()+
                                            "' and jam_rawat='"+tbPemeriksaanInfus.getValueAt(i,5).toString()+"' ");
                                }else{
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnSeekPetugas2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeekPetugas2ActionPerformed
        akses.setform("DlgRawatInap"); //prdr
        perawatan.petugas.emptTeks();
        perawatan.petugas.isCek();
        perawatan.petugas.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        perawatan.petugas.setLocationRelativeTo(internalFrame1);
    ...
    private void BtnSeekPegawaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeekPegawaiActionPerformed
        akses.setform("DlgRawatInap"); //soap
        pegawai.emptTeks();
    ...
    private void BtnTemplateObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTemplateObatActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgTemplatePemberianObatRi template=new DlgTemplatePemberianObatRi(null,false);
            template.isCek();
            template.setRM(TNoRw.getText(),TNoRM.getText(),TPasien.getText(),DTPTgl.getDate());
            template.tampil();
    ...
    }//GEN-LAST:event_BtnTemplateObatActionPerformed

    private void BtnTemplateObatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnTemplateObatKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnTemplateObatKeyPressed
    ...
    private void BtnSeekPegawai2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeekPegawai2ActionPerformed
        akses.setform("DlgRawatInap"); //tbak
        pegawai.emptTeks();
        pegawai.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        pegawai.setLocationRelativeTo(internalFrame1);
    ...
    private void BtnVerifSbar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVerifSbar1ActionPerformed
        if(TNoRw.getText().trim().equals("") ){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgTBAK soap=new DlgTBAK(null,false);
            soap.setNoRawat(TNoRw.getText(),TNoRw.getText());
            soap.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
            soap.setLocationRelativeTo(internalFrame1);
            soap.setVisible(true);
    ...
    private void tbPemeriksaan1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbPemeriksaan1MouseClicked
        if(tabModePemeriksaanAdime.getRowCount()!=0){
            try {
                getDataPemeriksaanAdime();
            } catch (java.lang.NullPointerException e) {
            }

        }        // TODO add your handling code here:
    }//GEN-LAST:event_tbPemeriksaan1MouseClicked

    private void tbPemeriksaan1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbPemeriksaan1KeyReleased
        if(tabModePemeriksaanAdime.getRowCount()!=0){
            if((evt.getKeyCode()==KeyEvent.VK_ENTER)||(evt.getKeyCode()==KeyEvent.VK_UP)||(evt.getKeyCode()==KeyEvent.VK_DOWN)){
                try {
                    getDataPemeriksaanAdime();
    ...
    private void TPenilaian1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TPenilaian1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TPenilaian1KeyPressed
    ...
    private void KdPeg1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdPeg1KeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            ...
            Valid.pindah(evt,TNoRw,TKeluhan1);
        }        // TODO add your handling code here:
    ...
    private void BtnSeekPegawai3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeekPegawai3ActionPerformed
        ...
        pegawaiadime.emptTeks();
        pegawaiadime.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        pegawaiadime.setLocationRelativeTo(internalFrame1);
        pegawaiadime.setVisible(true);        // TODO add your handling code here:
    }//GEN-LAST:event_BtnSeekPegawai3ActionPerformed

    private void TInstruksi1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TInstruksi1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TInstruksi1KeyPressed
    ...
    private void TEvaluasi1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TEvaluasi1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TEvaluasi1KeyPressed

    private void Btn5Soap3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn5Soap3ActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else if(TPegawai1.getText().trim().equals("")||KdPeg1.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu petugas/dokter pemberi asuhan...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            soapterakhiradime.setNoRM(TNoRM.getText(),KdPeg1.getText(),"Ranap");
            soapterakhiradime.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            soapterakhiradime.setLocationRelativeTo(internalFrame1);
            soapterakhiradime.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }        // TODO add your handling code here:
    }//GEN-LAST:event_Btn5Soap3ActionPerformed
    ...
    private void BtnVerifikasiTBAKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVerifikasiTBAKActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnVerifikasiTBAKActionPerformed
    ...
    private void BtnAwalMedisKandungan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisKandungan1ActionPerformed
         if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            AsesmenAwalMedisRanapNeonatus form=new AsesmenAwalMedisRanapNeonatus(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    private void TSuhu1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TSuhu1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TSuhu1ActionPerformed

    private void tbPemeriksaanInfusMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbPemeriksaanInfusMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tbPemeriksaanInfusMouseClicked

    private void tbPemeriksaanInfusKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbPemeriksaanInfusKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_tbPemeriksaanInfusKeyReleased
    ...
    private void TSituation2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TSituation2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TSituation2KeyPressed

    private void TBackground2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TBackground2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TBackground2KeyPressed

    private void TAssesment2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TAssesment2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TAssesment2KeyPressed

    private void TRecommendation2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TRecommendation2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TRecommendation2KeyPressed

    private void KdPeg6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KdPeg6ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_KdPeg6ActionPerformed

    private void KdPeg6KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdPeg6KeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            Sequel.cariIsi("select pegawai.nama from pegawai where pegawai.nik=?",TPegawai6,KdPeg6.getText());
        }else if(evt.getKeyCode()==KeyEvent.VK_UP){
            BtnSeekPegawai4ActionPerformed(null);
        }else{
            Valid.pindah(evt,TNoRw,TSituation2);
        } //SBAR // TODO add your handling code here:
    }//GEN-LAST:event_KdPeg6KeyPressed

    private void TPegawai6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TPegawai6ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TPegawai6ActionPerformed
    ...
    private void KdPeg7KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdPeg7KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KdPeg7KeyPressed

    private void Jabatan4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Jabatan4ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Jabatan4ActionPerformed
    ...
    private void Jabatan5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Jabatan5ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Jabatan5ActionPerformed
    ...
    private void KdPeg1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KdPeg1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_KdPeg1ActionPerformed
    ...
    */
    ...
    private widget.Button BtnTemplateObat;
    ...
    private javax.swing.JMenuItem CheklistFisioterapi;
    ...
    private widget.TextBox Jabatan3;
    private widget.TextBox Jabatan4;
    private widget.TextBox Jabatan5;
    ...
    private widget.TextBox KdPeg6;
    private widget.TextBox KdPeg7;
    ...
    private widget.TextArea TAssesment2;
    private widget.TextArea TBackground;
    private widget.TextArea TBackground1;
    private widget.TextArea TBackground2;
    ...
    private widget.TextArea TEvaluasi1;
    ...
    private widget.TextArea TInstruksi1;
    ...
    private widget.TextBox TPegawai6;
    private widget.TextBox TPegawai7;
    ...
    private widget.TextArea TPenilaian1;
    ...
    private widget.TextArea TRecommendation2;
    ...
    private widget.TextArea TSituation2;
    ...
    private widget.Table tbPemeriksaan1;
    private widget.Table tbPemeriksaanGinekologi;
    private widget.Table tbPemeriksaanInfus;
    ...
    public void isCek(){
        ...
        if(akses.getjml2()>=1){
            ...
            TPegawai6.setText(pegawai.tampil3(KdPeg.getText()));
            Jabatan.setText(pegawai.tampilJbatan(KdPeg.getText()));
        }
    }
    ...
    private void tampilPemeriksaanTbak() {
        ...
        try{  
            ps7=koneksi.prepareStatement("select pemeriksaan_ranap_tbak.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                ...
                "pemeriksaan_ranap_tbak.assesment,pemeriksaan_ranap_tbak.recommendation,pemeriksaan_ranap_tbak.nip,pegawai.nama,pegawai.jbtn,IF(vpt.no_rawat IS NOT NULL, 'Tervalidasi', 'Belum Divalidasi') " +
                "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join pemeriksaan_ranap_tbak on pemeriksaan_ranap_tbak.no_rawat=reg_periksa.no_rawat "+
                "inner join pegawai on pemeriksaan_ranap_tbak.nip=pegawai.nik "+
    ...
    private void tampilPemeriksaanInfus() {
        Valid.tabelKosong(tabModePemeriksaanInfus);
        try{  
            ps9=koneksi.prepareStatement("select pemeriksaan_ranap_infus.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                "pemeriksaan_ranap_infus.tgl_perawatan,pemeriksaan_ranap_infus.jam_rawat,pemeriksaan_ranap_infus.situation,pemeriksaan_ranap_infus.background, " +
                "pemeriksaan_ranap_infus.assesment,pemeriksaan_ranap_infus.recommendation,pemeriksaan_ranap_infus.nip,pegawai.nama,pegawai.jbtn " +
                "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join pemeriksaan_ranap_infus on pemeriksaan_ranap_infus.no_rawat=reg_periksa.no_rawat "+
                "inner join pegawai on pemeriksaan_ranap_infus.nip=pegawai.nik  where "+
                "pemeriksaan_ranap_infus.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? "+
                (TCari.getText().trim().equals("")?"":"and (pemeriksaan_ranap_infus.no_rawat like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                "pemeriksaan_ranap_infus.situation like ? or pemeriksaan_ranap_infus.background like ? or pemeriksaan_ranap_infus.assesment like ? or "+
                "pemeriksaan_ranap_infus.recommendation like ?)")+
                "order by pemeriksaan_ranap_infus.no_rawat,pemeriksaan_ranap_infus.tgl_perawatan,pemeriksaan_ranap_infus.jam_rawat desc"); 
            try{
                ps9.setString(1,Valid.SetTgl(DTPCari1.getSelectedItem()+""));
                ps9.setString(2,Valid.SetTgl(DTPCari2.getSelectedItem()+""));
                ps9.setString(3,"%"+TCariPasien.getText()+"%");
                if(!TCari.getText().trim().equals("")){
                ...
                rs=ps9.executeQuery();
                while(rs.next()){
                    tabModePemeriksaanInfus.addRow(new Object[]{
                        false,rs.getString(1),rs.getString(2),rs.getString(3),
                        rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),
                        rs.getString(8),rs.getString(9),rs.getString(10),rs.getString(11),
                        rs.getString(12),rs.getString(13)
        ...
        LCount.setText(""+tabModePemeriksaanInfus.getRowCount());
    }    
    ...
    private void getDataPemeriksaanAdime() {
        if(tbPemeriksaan1.getSelectedRow()!= -1){
            TNoRw.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),1).toString());
            TNoRM.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),2).toString());
            TPasien.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),3).toString());             
            TSuhu1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),6).toString()); 
            TTensi1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),7).toString()); 
            TNadi1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),8).toString()); 
            TRespirasi1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),9).toString()); 
            TTinggi1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),10).toString()); 
            TBerat1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),11).toString());  
            SpO3.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),12).toString());  
            TGCS1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),13).toString()); 
            cmbKesadaran1.setSelectedItem(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),14).toString()); 
            TKeluhan1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),15).toString()); 
            TPemeriksaan1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),16).toString()); 
            TAlergi1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),17).toString()); 
            TPenilaian1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),18).toString()); 
            TindakLanjut1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),19).toString()); 
            TInstruksi1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),20).toString());  
            TEvaluasi1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),21).toString()); 
            cmbJam.setSelectedItem(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),5).toString().substring(0,2));
            cmbMnt.setSelectedItem(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),5).toString().substring(3,5));
            cmbDtk.setSelectedItem(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),5).toString().substring(6,8));
            Valid.SetTgl(DTPTgl,tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(),4).toString());
        }
    }
    
    private void isFormAdime(){
        if(ChkInput5.isSelected()==true){
            ChkInput5.setVisible(false);
            PanelInput6.setPreferredSize(new Dimension(WIDTH,308));
    ...
    private void tampilPemeriksaanAdime() {
        Valid.tabelKosong(tabModePemeriksaanAdime);
        try{  
            ps4=koneksi.prepareStatement("select pemeriksaan_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                "pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat,pemeriksaan_ranap.suhu_tubuh,pemeriksaan_ranap.tensi, " +
                "pemeriksaan_ranap.nadi,pemeriksaan_ranap.respirasi,pemeriksaan_ranap.tinggi, " +
            ...
            try{
                ...
                rs=ps4.executeQuery();
                while(rs.next()){
                    tabModePemeriksaanAdime.addRow(new Object[]{
                        false,rs.getString(1),rs.getString(2),rs.getString(3),
                        rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),
                        rs.getString(8),rs.getString(9),rs.getString(10),rs.getString(11),
                        rs.getString(12),rs.getString(13),rs.getString(14),rs.getString(15),
        ...
        LCount.setText(""+tabModePemeriksaanAdime.getRowCount());
    }
