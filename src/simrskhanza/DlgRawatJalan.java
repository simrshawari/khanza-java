...
import rekammedis.RMPemeriksaanFisikMata;
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private String aktifkanparsial="no",kode_poli="",kd_pj="",poli_ralan="No",cara_bayar_ralan="No",
            ...
            Beban_Jasa_Menejemen_Tindakan_Ralan="",Utang_Jasa_Menejemen_Tindakan_Ralan="",no_sep="",finger="",tanggal="",poli="",variabel="",mode="";
    ...
    private void initComponents() {
        ...
        BtnPrintKlaim = new widget.Button();
        ...
        BtnResepRanap = new widget.Button();
        BtnTambahTindakan3 = new widget.Button();
        BtnInputKonsul2 = new widget.Button();
        BtnInputKonsul3 = new widget.Button();
        ...
        BtnPemeriksaanFisikMata = new widget.Button();
        ...
        BtnPrintKlaim.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/b_print.png"))); // NOI18N
        BtnPrintKlaim.setMnemonic('T');
        BtnPrintKlaim.setText("Cetak Berkas Klaim");
        BtnPrintKlaim.setToolTipText("Alt+T");
        BtnPrintKlaim.setName("BtnPrintKlaim"); // NOI18N
        BtnPrintKlaim.setPreferredSize(new java.awt.Dimension(150, 30));
        BtnPrintKlaim.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPrintKlaimActionPerformed(evt);
            }
        });
        BtnPrintKlaim.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnPrintKlaimKeyPressed(evt);
            }
        });
        panelGlass8.add(BtnPrintKlaim);
        ...
        scrollPane1.setBounds(83, 70, 350, 60);

        jLabel28.setText("Asesmen :");
        jLabel28.setName("jLabel28"); // NOI18N
        panelGlass12.add(jLabel28);
        jLabel28.setBounds(440, 40, 90, 23);
        ...
        scrollPane2.setBounds(80, 140, 350, 60);
        ...
        TTinggi.setBounds(250, 210, 55, 23);
        ...
        TRespirasi.setBounds(250, 240, 55, 23);
        ...
        TBerat.setBounds(390, 210, 55, 23);
        ...
        TAlergi.setBounds(930, 10, 206, 23);
        ...
        jLabel29.setBounds(430, 10, 70, 23);
        ...
        cmbKesadaran.setBounds(510, 10, 126, 23);
        ...
        scrollPane8.setBounds(540, 210, 360, 60);
        ...
        LingkarPerut.setBounds(970, 40, 55, 23);
        ...
        btnAmbilPhoto1.setBounds(910, 70, 130, 20);

        BtnSimpan1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnSimpan1.setMnemonic('S');
        BtnSimpan1.setText("Simpan Temp SOAP");
        ...
        BtnSimpan1.setBounds(1040, 70, 160, 20);
        ...
        Btn5Soap1.setBounds(910, 130, 150, 26);
        ...
        Btn5Soap2.setBounds(910, 160, 150, 26);
        ...
        BtnHasilRadiologi.setBounds(910, 190, 150, 26);
        ...
        BtnHasilPengobatan.setBounds(910, 220, 150, 26);
        ...
        BtnHasilPengobatan1.setBounds(910, 250, 150, 26);
        ...
        BtnInputLAB.setBounds(1060, 130, 160, 26);
        ...
        BtnInputRAD.setBounds(1060, 160, 160, 26);

        BtnResepRanap.setForeground(new java.awt.Color(0, 0, 0));
        BtnResepRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Edit.png"))); // NOI18N
        BtnResepRanap.setMnemonic('4');
        BtnResepRanap.setText("Input Resep Ranap");
        BtnResepRanap.setToolTipText("");
        BtnResepRanap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnResepRanap.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnResepRanap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnResepRanap.setName("BtnResepRanap"); // NOI18N
        BtnResepRanap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnResepRanapActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnResepRanap);
        BtnResepRanap.setBounds(1060, 220, 160, 26);

        BtnTambahTindakan3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/plus_16.png"))); // NOI18N
        BtnTambahTindakan3.setMnemonic('3');
        BtnTambahTindakan3.setToolTipText("Alt+3");
        BtnTambahTindakan3.setName("BtnTambahTindakan3"); // NOI18N
        BtnTambahTindakan3.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnTambahTindakan3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnTambahTindakan3ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnTambahTindakan3);
        BtnTambahTindakan3.setBounds(1140, 10, 28, 23);
        ...
        BtnInputKonsul2.setBounds(910, 100, 150, 26);

        BtnInputKonsul3.setForeground(new java.awt.Color(0, 0, 0));
        BtnInputKonsul3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Edit.png"))); // NOI18N
        BtnInputKonsul3.setMnemonic('4');
        BtnInputKonsul3.setText("Input Resep Ralan");
        BtnInputKonsul3.setToolTipText("");
        BtnInputKonsul3.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnInputKonsul3.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnInputKonsul3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnInputKonsul3.setName("BtnInputKonsul3"); // NOI18N
        BtnInputKonsul3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnInputKonsul3ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnInputKonsul3);
        BtnInputKonsul3.setBounds(1060, 190, 160, 26);
        ...
        BtnRiwayatFKTP.setBounds(1060, 250, 160, 26);
        ...
        BtnTemplateResep.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnTemplateResepKeyPressed(evt);
            }
        });
        ...
        BtnPermintaanLab1.setText("Surat Konsultasi");
        ...
        FormMenu.add(BtnPermintaanLab1);
        ...
        BtnPemeriksaanFisikMata.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnPemeriksaanFisikMata.setText("Pemeriksaan Fisik Mata");
        BtnPemeriksaanFisikMata.setFocusPainted(false);
        BtnPemeriksaanFisikMata.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPemeriksaanFisikMata.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnPemeriksaanFisikMata.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPemeriksaanFisikMata.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnPemeriksaanFisikMata.setName("BtnPemeriksaanFisikMata"); // NOI18N
        BtnPemeriksaanFisikMata.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnPemeriksaanFisikMata.setRoundRect(false);
        BtnPemeriksaanFisikMata.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPemeriksaanFisikMataActionPerformed(evt);
            }
        });
        FormMenu.add(BtnPemeriksaanFisikMata);
        ...
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            switch (TabRawat.getSelectedIndex()) {
                ...
                if (akses.getkode().equals("Admin Utama")){
                    ...
                    } else if (TNoRw.getText().trim().equals("") || TNoRM.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
                    ...
                    TNoRw.getText(), Sequel.cariIsi("select CURRENT_TIMESTAMP()"), AlergiCode.getText(), cmbKategory.getSelectedItem().toString(), KdPeg1.getText(), TKeterangan.getText(), ReaksiCode.getText(), cmbSeverity.getSelectedItem().toString()
                }) == true) {
                tampil();
            emptTeks();
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnTemplateResepKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnTemplateResepKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnTemplateResepKeyPressed
    ...
    private void BtnTemplateObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTemplateObatActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgTemplatePemberianObat template=new DlgTemplatePemberianObat(null,false);
            template.isCek();
            template.setRM(TNoRw.getText(),TNoRM.getText(),TPasien.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem());
            template.tampil();
            template.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
            template.setLocationRelativeTo(internalFrame1);
            template.setVisible(true);
    ...
    private void BtnSimpan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan1ActionPerformed
        ...
        if(Kd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("template_pemeriksaan_dokter","?,?,?,?,?,?,?,?","No.Template",8,new String[]{
                Kd.getText(),KdDok.getText(),TKeluhan.getText(),TPemeriksaan.getText(),TPenilaian.getText(),TindakLanjut.getText(),
    ...
    private void BtnPrintKlaimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintKlaimActionPerformed
       this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(! TCari.getText().trim().equals("")){
            BtnCariActionPerformed(evt);
        }
        switch (TabRawat.getSelectedIndex()) {
            case 0:
                if(tabModeDr.getRowCount()==0){
                    ...
                    param.put("emailrs",akses.getemailrs());
                    param.put("logo",Sequel.cariGambar("select setting.logo from setting"));
                    param.put("logobpjs",Sequel.cariGambar("select gambar.bpjs from gambar"));
                    String pas=" and reg_periksa.no_rkm_medis like '%"+TCariPasien.getText()+"%' ";
            ...
            case 3:
                if(tabModePemeriksaan.getRowCount()==0){
                    ...
                    param.put("emailrs",akses.getemailrs());
                    param.put("logo",Sequel.cariGambar("select setting.logo from setting"));
                    no_sep=Sequel.cariIsi("select no_sep from bridging_sep where no_rawat=?",TNoRw.getText());
                    param.put("logobpjs",Sequel.cariGambar("select gambar.bpjs from gambar"));
                    param.put("no_sep",no_sep);
                    param.put("tglsep",Sequel.cariIsi("select DATE_FORMAT(bridging_sep.tglsep,'%d-%m-%Y')as tglsep from bridging_sep where no_sep=?",no_sep));
                    param.put("no_kartu",Sequel.cariIsi("select no_kartu from bridging_sep where no_sep=?",no_sep));
                    param.put("nomr",Sequel.cariIsi("select nomr from bridging_sep where no_sep=?",no_sep));
                    param.put("nama_pasien",Sequel.cariIsi("select nama_pasien from bridging_sep where no_sep=?",no_sep));
                    param.put("tanggal_lahir",Sequel.cariIsi("select DATE_FORMAT(bridging_sep.tanggal_lahir,'%d-%m-%Y')as tanggal_lahir from bridging_sep where no_sep=?",no_sep));
                    param.put("notelep",Sequel.cariIsi("select notelep from bridging_sep where no_sep=?",no_sep));
                    param.put("nmdpdjp",Sequel.cariIsi("select nmdpdjp from bridging_sep where no_sep=?",no_sep));
                    param.put("nmppkrujukan",Sequel.cariIsi("select nmppkrujukan from bridging_sep where no_sep=?",no_sep));
                    param.put("nmdiagnosaawal",Sequel.cariIsi("select nmdiagnosaawal from bridging_sep where no_sep=?",no_sep));
                    param.put("catatan",Sequel.cariIsi("select catatan from bridging_sep where no_sep=?",no_sep));
                    param.put("prb",Sequel.cariIsi("select bpjs_prb.prb from bpjs_prb where bpjs_prb.no_sep=?",no_sep));
                    param.put("peserta",Sequel.cariIsi("select peserta from bridging_sep where no_sep=?",no_sep));
                    param.put("klsnaik",Sequel.cariIsi("select klsnaik from bridging_sep where no_sep=?",no_sep));
                    param.put("tujuankunjungan",Sequel.cariIsi("select tujuankunjungan from bridging_sep where no_sep=?",no_sep));
                    param.put("flagprosedur",Sequel.cariIsi("select flagprosedur from bridging_sep where no_sep=?",no_sep));
                    param.put("jnspelayanan",Sequel.cariIsi("select jnspelayanan from bridging_sep where no_sep=?",no_sep));
                    param.put("klsrawat",Sequel.cariIsi("select klsrawat from bridging_sep where no_sep=?",no_sep));
                    param.put("lakalantas",Sequel.cariIsi("select lakalantas from bridging_sep where no_sep=?",no_sep));
                    param.put("nmpolitujuan",Sequel.cariIsi("select nmpolitujuan from bridging_sep where no_sep=?",no_sep));
                    param.put("anamnesa",Sequel.cariIsi("select keluhan from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
                    param.put("pemeriksaanfisik",Sequel.cariIsi("select pemeriksaan from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
                    param.put("rtl",Sequel.cariIsi("select rtl from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
                    param.put("radiologi",Sequel.cariIsi("select pemeriksaan_penunjang from resume_pasien where no_rawat=?",TNoRw.getText()));
                    param.put("lab",Sequel.cariIsi("select hasil_laborat from resume_pasien where no_rawat=?",TNoRw.getText()));
                    ...
                    param.put("prosedur",Sequel.cariIsi("select concat(prosedur_pasien.kode,' ',icd9.deskripsi_panjang) from prosedur_pasien inner join reg_periksa inner join icd9 "+
                    "on prosedur_pasien.no_rawat=reg_periksa.no_rawat and prosedur_pasien.kode=icd9.kode "+
                    "where prosedur_pasien.no_rawat=? and prosedur_pasien.prioritas='1'",TNoRw.getText()));
                    param.put("status",Sequel.cariIsi("select status_lanjut from reg_periksa where no_rawat=?",TNoRw.getText()));
                    param.put("umur",Sequel.cariIsi("select pasien.umur from pasien where pasien.no_rkm_medis=? ",TNoRM.getText()));
                    tanggal=Sequel.cariIsi("select reg_periksa.tgl_perawatan from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText());
                    ...
                    String tgl=" pemeriksaan_ralan.tgl_perawatan between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' "+pas;
                    Valid.MyReportqry("rptJalanPemeriksaanKlaim.jasper","report","::[ Data Pemeriksaan Rawat Jalan ]::",
                            "select pemeriksaan_ralan.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                            "pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,pemeriksaan_ralan.suhu_tubuh,pemeriksaan_ralan.tensi, " +
                            "pemeriksaan_ralan.nadi,pemeriksaan_ralan.respirasi,pemeriksaan_ralan.tinggi, " +
                            "pemeriksaan_ralan.berat,pemeriksaan_ralan.spo2,pemeriksaan_ralan.gcs,pemeriksaan_ralan.kesadaran,pemeriksaan_ralan.keluhan, " +
                            "pemeriksaan_ralan.pemeriksaan,pemeriksaan_ralan.alergi,pemeriksaan_ralan.lingkar_perut,"+
                            "pemeriksaan_ralan.rtl,pemeriksaan_ralan.penilaian,pemeriksaan_ralan.instruksi,pemeriksaan_ralan.evaluasi,pemeriksaan_ralan.nip,dokter.nm_dokter "+
                            "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                            "inner join pemeriksaan_ralan on pemeriksaan_ralan.no_rawat=reg_periksa.no_rawat "+
                            "inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where  "+
                            tgl+"and (pemeriksaan_ralan.no_rawat like '%"+TCari.getText().trim()+"%' or reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                            "pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or pemeriksaan_ralan.alergi like '%"+TCari.getText().trim()+"%' or "+
                            "pemeriksaan_ralan.keluhan like '%"+TCari.getText().trim()+"%' or pemeriksaan_ralan.penilaian like '%"+TCari.getText().trim()+"%' or "+
                            "pemeriksaan_ralan.pemeriksaan like '%"+TCari.getText().trim()+"%' or dokter.nm_dokter like '%"+TCari.getText().trim()+"%') "+
                            "order by pemeriksaan_ralan.no_rawat desc",param);
                }   break;
            case 4:
                if(tabModeObstetri.getRowCount()==0){
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_BtnPrintKlaimActionPerformed

    private void BtnPrintKlaimKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnPrintKlaimKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnPrintKlaimKeyPressed
    ...
    private void BtnResepRanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnResepRanapActionPerformed
            if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{            
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                DlgPeresepanDokterRalankeRanap resep=new DlgPeresepanDokterRalankeRanap(null,false);
                resep.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
                resep.setLocationRelativeTo(internalFrame1);
    ...
    }//GEN-LAST:event_BtnResepRanapActionPerformed

    private void BtnTambahTindakan3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahTindakan3ActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            catatan1.setNoRm(TNoRM.getText());
            catatan1.setSize(720,330);
            catatan1.setLocationRelativeTo(internalFrame1);
            catatan1.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_BtnTambahTindakan3ActionPerformed

    private void BtnInputKonsul2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnInputKonsul2ActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnInputKonsul2ActionPerformed

    private void BtnInputKonsul3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnInputKonsul3ActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{   
    ...
    }//GEN-LAST:event_BtnInputKonsul3ActionPerformed

    private void BtnRiwayatFKTPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayatFKTPActionPerformed
    ...
    private void btnJenisAlergiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJenisAlergiActionPerformed
        mode = "alergi";
    ...
    }//GEN-LAST:event_btnJenisAlergiActionPerformed

    private void btnJenisAlergiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnJenisAlergiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnJenisAlergiKeyPressed
    ...
    private void btnReaksiAlergiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReaksiAlergiActionPerformed
        mode = "reaksialergi";
        allergycode.isCek("reaksialergi");
        allergycode.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        allergycode.setLocationRelativeTo(internalFrame1);
        allergycode.setVisible(true);
    }//GEN-LAST:event_btnReaksiAlergiActionPerformed

    private void btnReaksiAlergiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnReaksiAlergiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnReaksiAlergiKeyPressed
    ...
    private void BtnPemeriksaanFisikMataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPemeriksaanFisikMataActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPemeriksaanFisikMata form=new RMPemeriksaanFisikMata(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnPemeriksaanFisikMataActionPerformed
    ...
    */
    ...
    private widget.Button BtnInputKonsul3;
    ...
    private widget.Button BtnPemeriksaanFisikMata;
    ...
    private widget.Button BtnPrintKlaim;
    ...
    private widget.Button BtnTambahTindakan3;
    ...
    private void isPsien(){
        ...
        TAlergi.setText(Sequel.cariIsi("select catatan from catatan_pasien_alergi where no_rkm_medis=?",TNoRM.getText()));
    }
