...
<div id="post">
    <div class="entry">        
        <form name="frm_aturadmin" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
                ...
                if (isset($BtnSimpan)) {
                    ...
                    if((strtolower(substr($gambar,-3))=="jpg")||(strtolower(substr($gambar,-4))=="jpeg")){
                        if ((!empty($no_inventaris))&&(!empty($gambar))) {
                            ...
                            Tambah(" inventaris_pemeliharaan_gambar "," '$no_inventaris','$gambar'", " Gambar Inventaris " );
            ...
            <?php
                $_sql = "SELECT * from inventaris_pemeliharaan_gambar where no_inventaris='$no_inventaris'";
        ...
        <?php
            if ($action=="HAPUS") {
                unlink($_GET['gambar']);
                Hapus(" inventaris_pemeliharaan_gambar "," no_inventaris ='".validTeks4($_GET['no_inventaris'],30)."' ","?act=List&action=TAMBAH&no_inventaris=$no_inventaris");
            }
